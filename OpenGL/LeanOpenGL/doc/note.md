...
![1762696318793](image/note/1762696318793.png)
...
![1763307989863](image/note/1763307989863.png)
...
![1763798216855](image/note/1763798216855.png)

这种差异产生的原因是，光的衰减方程改变了亮度值，而且屏幕上显示出来的也不是线性空间，在显示器上效果最好的衰减方程，并不是符合物理的。想想平方衰减方程，如果我们使用这个方程，而且不进行gamma校正，显示在监视器上的衰减方程实际上将变成**(**1.0**/**d**i**s**t**a**n**c**e**2**)**2.2。若不进行gamma校正，将产生更强烈的衰减。这也解释了为什么双曲线不用gamma校正时看起来更真实，因为它实际变成了**(**1.0**/**d**i**s**t**a**n**c**e**)**2.2**=**1.0**/**d**i**s**t**a**n**c**e**2.2**。这和物理公式是很相似的。
...
![1763391527988](image/note/1763391527988.png)

![1763391538732](image/note/1763391538732.png)

![1763391547373](image/note/1763391547373.png)

![1763391638653](image/note/1763391638653.png)

![1763391648892](image/note/1763391648892.png)

![1763391675961](image/note/1763391675961.png)

![1763391699984](image/note/1763391699984.png)
